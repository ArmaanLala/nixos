# Declarative disk layout for drapion's Samsung 980 PRO.
#
...
# stops booting; hosts/drapion/README-reinstall.md has the procedure.
{ ... }:
let
...
in
{
  ...
  fileSystems."/partition-root" = {
    device = "/dev/disk/by-label/drapion";
    fsType = "btrfs";
